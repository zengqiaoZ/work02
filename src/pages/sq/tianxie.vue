<template>
	<div>
		<mt-cell-group>
			...
			<mt-cell class="o-cell" title="休学原因" :required="true" is-link @click.native="XXYY()"></mt-cell>
		...
		<!-- 休学学年 -->
		<mt-popup v-model="showpopupXXXN" position="bottom"><mt-picker :columns="XXXNLIST" showToolbar @confirm="QDXXXN" @cancel="QXXXXN" /></mt-popup>
		<!-- 休学学期 -->
		<mt-popup v-model="showpopupXXXQ" position="bottom"><mt-picker :columns="XXXQLIST" showToolbar @confirm="QDXXXQ" @cancel="QXXXXQ" /></mt-popup>
		<!-- 休学原因 -->
		<mt-popup v-model="showpopupXXYY" position="bottom"><mt-picker :columns="XXYYLIST" showToolbar @confirm="QDXXYY" @cancel="QXXXYY" /></mt-popup>
	</div>
</template>
<style></style>
<style scoped>
	...
	methods: {
		...
		Savedrafts(i) {
			...
			Get(api.startFlow, {
				...
				commandEvent: 'com.wisedu.emap.pubdzxxsqapp.service.BtnClickEventListener',
